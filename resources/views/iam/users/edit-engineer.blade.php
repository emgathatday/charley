        ...
        <div class="edit-fixed-layout">
            ...
            <div class="edit-right">
                ...
                <div class="form-card" id="sec-expertise">
                    ...
                    <div class="form-body"><div class="form-row"><div class="form-group"><label class="form-label">Primary Plant Focus <span class="required">*</span></label><div class="checkbox-chip-group" id="plantGroup">@foreach ($plantTypeOptions as $plantTypeId => $plantTypeName)<label class="checkbox-chip"><input type="checkbox" name="plant_type_ids[]" value="{{ $plantTypeId }}" @checked(in_array((string) $plantTypeId, $selectedPlantTypes, true))><span class="checkbox-chip-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></span>{{ $plantTypeName }}</label>@endforeach</div>@error('plant_type_ids')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror<div class="form-hint">Determines the default plant handbook and AI context.</div></div></div><div class="form-row"><div class="form-group"><label class="form-label">Technical Expertise Areas</label><input class="form-input" type="text" name="expertise_tags" value="{{ old('expertise_tags', $expertiseTags) }}" placeholder="Primary Reformer, Catalyst Management, PSA / Purification"></div></div><div class="form-row"><div class="form-group"><label class="form-label">Searchable Keywords</label><input class="form-input" type="text" name="searchable_keywords" value="{{ old('searchable_keywords', $searchableKeywords) }}" placeholder="reforming, hydrogen, PSA, catalyst"></div></div></div>
                </div>

                <div class="form-card" id="sec-topexpertise"><div class="form-card-head"><div class="form-accent blue"></div><div class="form-head-inner"><div class="form-icon blue"><svg class="icon"><use href="/assets/icons/sprite.svg#icon-top-expertise-areas-svg-viewbox-0"></use></svg></div><div><div class="form-title">Top Expertise Areas</div><div class="form-sub">Self-assessment ceiling remains static until quiz data is contracted</div></div></div></div><div class="form-body"><div class="expertise-section"><div class="expertise-section-title">Current top areas</div><input class="form-input" type="text" name="industry_specialization" value="{{ old('industry_specialization', $industrySpecialization) }}" placeholder="Primary Reformer, Catalyst Management, PSA / Purification"></div><div class="form-hint">TODO-safe boundary: score sliders and quiz ceiling are static in the source design until reputation contracts are supplied.</div></div></div>
